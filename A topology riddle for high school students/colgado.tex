...
\begin{frame}{Curva $\rightarrow$ formulita}
	...
	\visible<2->{ \center{Nombre de la config: \color{red} \Huge{x $\cdot$ y}}}
...
\begin{frame}{Curva $\rightarrow$ formulita}
	...
	\color{red} \center{\Huge{y $\cdot$ x}}
...
\center{\Large{¡Desaparece la letra!}}
...
¿Qué queremos?
\visible<2->{Queremos una fórmula que no sea equivalente a 1 pero cuando saco cualquiera de las dos letras, sí.}
\bigskip
\visible<3->{Recuerdo: $x \cdot x^{-1} = 1$. Ídem con $y$}
...
\center{\scalebox{2.5}{$x \cdot y \cdot x^{-1} \cdot y^{-1}$}}
